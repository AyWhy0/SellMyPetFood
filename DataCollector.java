...
public class DataCollector
{
   ...
   */
  public static void prepareAdvertisement(String filename, String usernames, String advertisementFileName)
  {
    String advertisement = getAdvertisement(advertisementFileName);
    try
    {
  ...
  /** Returns a string of the advertisement in the advertisement text file */
  private static String getAdvertisement(String fileName) {
    String advertisement = "";
    try
    {
      Scanner scanAdvertisement = new Scanner(new File(fileName));
      while (scanAdvertisement.hasNextLine())
      {
        // String method trim removes whitespace before and after a string
        // String temp = sc.nextLine().trim();
        String temp = scanAdvertisement.nextLine();

        // DEBUG: System.out.println(temp);
        advertisement += temp + "\n";
      }
    } catch (Exception e) { System.out.println("Error reading or parsing" + fileName + "\n" + e); }
